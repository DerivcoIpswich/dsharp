...
namespace System.Collections.Generic
{
                                                                                           ...
                                                                                           // ICollection<KeyValuePair<TKey, TValue>> inherits from IEnumerable<T>
    {
        ...
        public extern void Remove(TKey key);  // This should return  bool
        ...
        // Are we sure we want to be able to cast from Dictionary to Dictionary<T,V> and viceversa? This sounds like js.
